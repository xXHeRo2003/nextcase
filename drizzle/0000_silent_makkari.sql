...
CREATE TABLE "market_pools" (
	...
	"liquidity" numeric(40, 18) DEFAULT '100.00' NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "unique_pool" UNIQUE("market_id","outcome_index")
);
--> statement-breakpoint
...
CREATE TABLE "user_positions" (
	...
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "unique_position" UNIQUE("user_id","market_id","outcome_index")
);
--> statement-breakpoint
...
ALTER TABLE "market_pools" ADD CONSTRAINT "market_pools_market_id_markets_id_fk" FOREIGN KEY ("market_id") REFERENCES "public"."markets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "session" ADD CONSTRAINT "session_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_positions" ADD CONSTRAINT "user_positions_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
